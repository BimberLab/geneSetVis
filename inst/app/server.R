...
server = function(input, output, session) {
  ...
  output$downloadReport <- downloadHandler(
    ...
    content = function(file) {
      ...
      #file.copy('../template_report.Rmd', paste0(envir$cachedir, "/geneSetVis-exports", "/template_report.Rmd"))
      file.copy(system.file('template_report.Rmd', package = 'geneSetVis'), paste0(envir$cachedir, "/geneSetVis-exports", "/template_report.Rmd"))
