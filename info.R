...
clusterprofiler_resource_info <- list(
  title = "clusterProfiler Resource info", 
  text = HTML(
    '<b>clusterProfiler</b><br>
    ...
  <p>
  <li><a href=https://bioconductor.org/packages/release/bioc/vignettes/clusterProfiler/inst/doc/clusterProfiler.html 
  title="Official clusterProfiler website" 
  target="_blank"><b>Official clusterProfiler website</b></a></li>
  '
  )
)
