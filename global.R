...
source('inst/app/modules/msigdb.R', local = TRUE)
source('inst/app/modules/reactome.R', local = TRUE)
source('inst/app/modules/david.R', local = TRUE)
source('inst/app/modules/dose.R', local = TRUE)
source('inst/app/modules/ncg.R', local = TRUE)
source('inst/app/modules/dgn.R', local = TRUE)
source('inst/app/modules/enrichr.R', local = TRUE)
source('inst/app/tabs.R', local = TRUE)
source('inst/app/ui.R', local = TRUE)
source('inst/app/server.R', local = TRUE)
source('R/helpers.R', local = TRUE)
source('R/uiElements.R', local = TRUE)
